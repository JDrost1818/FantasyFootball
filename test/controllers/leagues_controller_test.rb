...
class LeaguesControllerTest < ActionController::TestCase
  ...
  test "should create league" do
    assert_difference('League.count') do
      post :create, league: { description: @league.description, name: @league.name, salary_cap: @league.salary_cap }
    end
  ...
  test "should update league" do
    patch :update, id: @league, league: { description: @league.description, name: @league.name, salary_cap: @league.salary_cap }
    assert_redirected_to league_path(assigns(:league))
  end
